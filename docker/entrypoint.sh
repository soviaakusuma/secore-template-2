...
set -x
exec java -cp $APPLICATION_JAR_PATH/\* -XX:+ExitOnOutOfMemoryError -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=$HEAPDUMPDIR -Xms128M -Xmx256M $JAVA_OPTS $MAIN_CLASS "$@" 
